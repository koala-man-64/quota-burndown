---
name: burndown
description: Read live Codex and Claude quota capacity and freshness, inspect token accounting, and open the local dashboard. Use for allowance remaining, burn rate, reserves, session/model usage or /burndown.
---
...
```
py -B "${CLAUDE_PLUGIN_ROOT}/quota-burndown.py" capacity --json
```
